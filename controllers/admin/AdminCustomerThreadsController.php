...
class AdminCustomerThreadsControllerCore extends AdminController
{
    ...
    {
        if (isset($_GET['filename']) && (bool)Tools::file_get_contents(Context::getContext()->link->getMediaLink(_THEME_PROD_PIC_DIR_.$_GET['filename'])) && Validate::isFileName($_GET['filename'])) { // by webkul
    ...
    protected function displayMessage($message, $email = false, $id_employee = null)
    {
        ...
        $tpl->assign(array(
            ...
            'file_name' => (bool)Tools::file_get_contents(Context::getContext()->link->getMediaLink(_THEME_PROD_PIC_DIR_.$message['file_name'])), // by webkul
            'contacts' => $contacts,
